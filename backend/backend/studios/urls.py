...
urlpatterns = [
    ...
    path('<int:studio_id>/classes/<int:class_id>/enrol/multiple', EnrolMultipleAPIView.as_view()),
    path('<int:studio_id>/classes/<int:class_id>/drop/', DropAPIView.as_view()),
    path('<int:studio_id>/classes/<int:class_id>/drop/multiple', DropMultipleAPIView.as_view()),
